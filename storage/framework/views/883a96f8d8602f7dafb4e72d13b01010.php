...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BPM'); ?> | Sistem Kinerja BPM</title>
...
<nav id="sidebar">
    ...
    <div class="sb-nav">
        ...
        <a href="<?php echo e(route('realisasi.create')); ?>" class="sb-link <?php echo e(request()->routeIs('realisasi.create') ? 'active' : ''); ?>">
            <i class="bi bi-pencil-square"></i>Input Realisasi
        </a>
        <a href="<?php echo e(route('laporan.draft')); ?>" class="sb-link <?php echo e(request()->routeIs('laporan.draft') ? 'active' : ''); ?>">
            <i class="bi bi-file-earmark-text"></i>Draft Laporan
        </a>
        <?php endif; ?>
        <a href="<?php echo e(route('laporan.final')); ?>" class="sb-link <?php echo e(request()->routeIs('laporan.final') ? 'active' : ''); ?>">
            <i class="bi bi-file-earmark-check"></i>Laporan Final
        </a>

        <div class="sb-sec">Indikator Kinerja</div>
        <a href="<?php echo e(route('indikator.index')); ?>" class="sb-link <?php echo e(request()->routeIs('indikator.*') ? 'active' : ''); ?>">
            <i class="bi bi-list-check"></i>Daftar Indikator
        </a>

        <div class="sb-sec">Dokumen Mutu</div>
        <a href="<?php echo e(route('dokumen.website.index')); ?>" class="sb-link <?php echo e(request()->routeIs('dokumen.website.*') ? 'active' : ''); ?>">
            <i class="bi bi-globe"></i>Dokumen Website
        </a>
        <a href="<?php echo e(route('dokumen.spmi.index')); ?>" class="sb-link <?php echo e(request()->routeIs('dokumen.spmi.*') ? 'active' : ''); ?>">
            <i class="bi bi-folder2-open"></i>Dokumen SPMI
        </a>
        <a href="<?php echo e(route('pedoman.index')); ?>" class="sb-link <?php echo e(request()->routeIs('pedoman.*') ? 'active' : ''); ?>">
            <i class="bi bi-book"></i>Pedoman dan SOP
        </a>

        <div class="sb-sec">Akreditasi</div>
        <a href="<?php echo e(route('akreditasi.index')); ?>" class="sb-link <?php echo e(request()->routeIs('akreditasi.*') ? 'active' : ''); ?>">
            <i class="bi bi-award"></i>Data Akreditasi
        </a>

        <div class="sb-sec">Survei & Kepuasan</div>
        <a href="<?php echo e(route('survei.index')); ?>" class="sb-link <?php echo e(request()->routeIs('survei.*') ? 'active' : ''); ?>">
            <i class="bi bi-clipboard-data"></i>Survei Kepuasan
        </a>
        <a href="<?php echo e(route('kepuasan.index')); ?>" class="sb-link <?php echo e(request()->routeIs('kepuasan.*') ? 'active' : ''); ?>">
            <i class="bi bi-bar-chart"></i>Hasil Survei
        </a>

        <?php if(auth()->user()->isAdmin()): ?>
        <div class="sb-sec">Manajemen Pengguna</div>
        <a href="<?php echo e(route('users.index')); ?>" class="sb-link <?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>">
            <i class="bi bi-people"></i>User
        </a>
        <a href="<?php echo e(route('roles.index')); ?>" class="sb-link <?php echo e(request()->routeIs('roles.*') ? 'active' : ''); ?>">
...
<div id="main">
    <div class="topbar">
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="tb-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
        </div>
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="dropdown">
                <button class="btn btn-sm d-flex align-items-center gap-2 border-0" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-inline text-muted" style="font-size:12px"><?php echo e(auth()->user()->name); ?></span>
...
<?php /**PATH C:\Users\maria\bpm-full\resources\views/layouts/app.blade.php ENDPATH**/ ?>