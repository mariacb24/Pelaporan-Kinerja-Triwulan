...
<div class="login-wrap">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                           value="{{ old('email') }}" placeholder="email@ukdc.ac.id" required autofocus>
                </div>
            </div>
            <div class="mb-3">
    ...
    <div class="footer-text">© {{ date('Y') }} Badan Penjaminan Mutu · Universitas Katolik Darma Cendika Surabaya</div>
</div>
